defmodule BEAMBetterHaveMyMoney.Exchanger.ExchangeRate do
  ...
  @type t :: %__MODULE__{from_currency: String.t(), to_currency: String.t(), exchange_rate: String.t()}

  @spec new(map) :: t()
  def new(%{"1. From_Currency Code" => from_currency, "3. To_Currency Code" => to_currency, "5. Exchange Rate" => exchange_rate}) do
